...
//        _imagePickerVc.navigationBar.barTintColor = Color_BG_BLACK;
        _imagePickerVc.navigationBar.barTintColor=[UIColor blackColor];
        _imagePickerVc.navigationBar.tintColor = [UIColor orangeColor];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == _selectedPhotos.count) {
        cell.imageView.image = [UIImage imageNamed:@"camera_img"];
        cell.deleteBtn.hidden = YES;
        cell.imageView.tag=110;
    } else {
...
#pragma clang diagnostic pop
            [sheet showInView:self.ctl.view];
        } else {
        ...
        if (isVideo) { // perview video / 预览视频
            ...
            //            vc.model = model;
            //            [self.ctl presentViewController:vc animated:YES completion:nil];
            ...
            [self.ctl presentViewController:imagePickerVc animated:YES completion:nil];
        }
    }
}
...
#define push @#clang diagnostic pop
        ...
        if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]) {
            ...
            [self.ctl presentViewController:_imagePickerVc animated:YES completion:nil];
        } else {
